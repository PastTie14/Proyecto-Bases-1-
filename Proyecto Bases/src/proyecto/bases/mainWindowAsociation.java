...
public class mainWindowAsociation extends JFrame {
    ...
    private AssociationFormPanel config;

    public mainWindowAsociation(int idUser) {
        this.idUser = idUser;
        initUI();
    }
    ...
    private void initComponents() {
        ...
        config = new AssociationFormPanel(idUser);
