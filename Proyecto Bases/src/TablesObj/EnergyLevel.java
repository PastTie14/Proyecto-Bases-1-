...
public class EnergyLevel extends DBItem {
    ...
    public EnergyLevel(int id) { this.id = id; }
    ...
    private void loadData() {
        ...
        try {
            ...
            LOG.log(Level.SEVERE, "Error loading EnergyLevel id=" + id, ex);
        }
    }
    ...
    @Override
    public void deleteItem() { throw new UnsupportedOperationException("No delete SP for EnergyLevel."); }
