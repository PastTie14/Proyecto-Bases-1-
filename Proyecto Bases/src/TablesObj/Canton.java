 ...
 *   2  id_province
 */
public class Canton extends DBItem {

    private static final Logger LOG = Logger.getLogger(Canton.class.getName());
    private final int id;
    private ArrayList<String> data;

    public Canton(int id) { this.id = id; }
    ...
    private void loadData() {
        ...
        try {
            ...
            LOG.log(Level.SEVERE, "Error loading Canton id=" + id, ex);
        }
    }
    ...
    public int    getIdProvince() { loadData(); return getInt(2); }
