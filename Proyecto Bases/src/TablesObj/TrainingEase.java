...
public class TrainingEase extends DBItem {
    ...
    public TrainingEase(int id) { this.id = id; }
    ...
    private void loadData() {
        ...
        try {
            ...
            LOG.log(Level.SEVERE, "Error loading TrainingEase id=" + id, ex);
        }
    }
    ...
    @Override
    public void deleteItem() { throw new UnsupportedOperationException("No delete SP for TrainingEase."); }
