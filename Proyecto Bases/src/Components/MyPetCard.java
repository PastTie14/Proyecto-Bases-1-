...
public class MyPetCard extends JPanel {
    ...
    public MyPetCard(Frame parent, Pet pet, int idUser, MyPetsPanel owner) {
        this.pet = pet;
    ...
    protected void onCardClicked() {
        ...
        new MyPetPopup(parent, pet, IdUser, owner).setVisible(true);
    }
